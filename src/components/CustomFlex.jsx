...
const CustomFlex = ({ theme }) => {
  const [textColor, setTextColor] = useState('black');

  useEffect(() => {
    // Update text color based on the theme change
    setTextColor(theme === 'dark' ? 'white' : 'black');
  }, [theme]);

  return (
    <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: 'white', color: textColor, padding: '10px' }}>
